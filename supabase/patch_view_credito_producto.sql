-- ============================================================
-- PARCHE: v_cuotas_pendientes — soporte crédito de producto
-- Cambia el INNER JOIN a garantias por LEFT JOIN para que las
-- cuotas de créditos de producto (garantia_id = NULL) aparezcan
-- en la vista correctamente.
-- ============================================================
...
LEFT JOIN garantias g  ON g.id  = p.garantia_id   -- LEFT JOIN: NULL cuando no hay garantía
